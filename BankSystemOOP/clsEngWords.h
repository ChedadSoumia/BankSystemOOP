...
#include <iostream>
    ...
    { "CurrencyExchangeMainScreen","Currency Exchange Main Screen" },
    { "CurrencyExchangeMenu","Currency Exchange Menu" },
    { "Country","Country" },
    ...
    { "RateUpdateSuccess","Currency rate update successfully" },
};
