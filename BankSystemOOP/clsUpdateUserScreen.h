...
private:
    ...
    static int _ReadPermissionsToSet()
    {
        ...
        cout << "\n" << clsLang::ToLang("LoginLogoutRegister", LangChosen) << "? y/n? ";
        cin >> Answer;
        if (Answer == 'y' || Answer == 'Y')
        {
...
public:
    ...
    static void ShowUpdateUserScreen()
    {
        ...
        cout << "\n"<< clsLang::ToLang("updatethisUser", LangChosen)<< "y/n? ";
        ...
        if (Answer == 'y' || Answer == 'Y')
        {
            ...
            cout << "\n\n"<< clsLang::ToLang("UpdateUserInfo", LangChosen)<< ":";
            ...
            {
                cout << "\n" << clsLang::ToLang("UserUpSucces", LangChosen) << ":-)\n";
            ...
            {
                cout << "\n" << clsLang::ToLang("ErrorEmptyU", LangChosen) ;
                break;
